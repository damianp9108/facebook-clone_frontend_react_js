...
class NavBar extends Component {
    ...
    logOut=()=>{
        ...
        fetch("http://localhost:8080/api/userService/changeActive/"+(JSON.parse(localStorage.getItem("user")).userID), requestOptions)
                ...
                <Grid item xs={3}>
                    <div className="navbar__right">
                        <div className="navbar__righttab">
                            <Avatar className="navbar__rightimg" src={getImage(JSON.parse(localStorage.getItem("user")).userImage)} />
                            <div className="navbar__profilenamer">{(JSON.parse(localStorage.getItem("user")).userName)}</div>
                        </div>
