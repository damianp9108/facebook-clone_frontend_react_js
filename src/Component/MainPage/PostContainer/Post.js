...
class Post extends Component {
    ...
    getData=()=>{
        ...
        fetch("http://localhost:8080/comments/getAllComments/"+this.props.object.postID)
        .then(response => response.json())
        .then(json => {
            thisContext.setState({comments : json});
            thisContext.setState({comment: ''});
    ...
    submitComment=(event)=>{
        ...
        let payload = {
            ...
            "comment" : thisContext.state.comment
        }
        ...
        fetch("http://localhost:8080/comments/save",requestOptions)
        .then(response => response.json())
        .then(data => {
                ...
                <Paper className="post__container">
                    ...
                    <div className="comment__section">
                        ...
                        <div className="upload__top">
                            ...
                            <div>
                                <input type='text' onKeyDown={this.submitComment} onChange={this.changeComment} value={this.state.comment} className="upload__box" placeholder="What's on your mind?" />
                            </div>
                        </div>
                    </div>
